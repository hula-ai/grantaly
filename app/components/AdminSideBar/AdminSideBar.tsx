...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const IsRouteScheduled = pathname.includes("/admin/schedule")
  const IsRoutePortfolio = pathname.includes("/admin/portfolio") 
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        style={{color: IsRouteDashboard ? '#0075FF' : ''}}
              ...
              <li>
                <Link
                  ...
                  style={{color: IsRouteProject ? '#0075FF' : ''}}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    IsRouteProject ? "bg-gray-200 dark:bg-meta-4" : ""
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  href={isAdmin ? "/admin/schedule" : "/user/schedule" }
                  style={{color: IsRouteScheduled ? '#0075FF' : ''}}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    IsRouteScheduled ? "bg-gray-200 dark:bg-meta-4" : ""
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              {/* <li>
                <Link
                  ...
                  style={{color: IsRoutePortfolio ? '#0075FF' : ''}}
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    IsRoutePortfolio ? "bg-gray-200 dark:bg-meta-4" : ""
                  }`}
                >
                  <svg
                    className="fill-current"
